...
- assets/scan.png
- assets/original/
- assets/original/서답5번_1-1. 다항식의 연산.png
- assets/original/서답5번_1-1. 다항식의 연산_scan.png
---

## Q
오른쪽 [그림 1]과 같이 물이 가득 담긴 직육면체 모양의 그릇에 직육면체 모양의 막대를 밑면과 맞닿게 수직으로 넣었다. 이때 남아 있는 물을 [그림 2]와 같은 직육면체 모양의 그릇에 옮겨 담았을 때,수면의 높이 \(h\)를 구하는 풀이 과정을 쓰고 답을 구하시오.
(단, 막대의 길이는 \(x+4\)보다 길다.)
