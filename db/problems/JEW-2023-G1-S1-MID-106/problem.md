...
## Q
은지와 주아가 이차방정식 \(x^2+ax+b=0\) (\(a,\ b\)는 실수)의 근을 구하려고 한다. 그런데 은지는 상수항을 잘못 보고 풀어 두 근 \(4+i,\ 4-i\)를 얻었고, 주아는 \(x\)의 계수를 잘못 보고 풀어 두 근 \(3+\sqrt{3}i,\ 3-\sqrt{3}i\)를 얻었다. 다음 물음에 답하시오.
