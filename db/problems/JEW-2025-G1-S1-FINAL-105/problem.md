...
---
## Q
삼차방정식 \(x^3-1=0\)의 한 허근을 \(\omega\)라 할 때, 두 행렬의 곱
\[
\begin{pmatrix}\omega & 1 \\ \omega^2 & -1\end{pmatrix}
\begin{pmatrix}\omega+1 & \omega \\ 0 & \omega^2\end{pmatrix}
\]
의 모든 성분의 합을 \(a\omega+b\)라 하자.
이때, 실수 \(a,\ b\)값을 각각 구하시오.
