...
assets:
  ...
  - assets/original/
  - assets/original/013_2-2. 이차방정식과 이차함수_2.png
---

## Q
이차함수 \(f(x)=x^2+ax+b\)가 다음 조건을 모두 만족시킬 때, \(-1\le x\le 4\)에서의 \(f(x)\)의 최댓값은? (단, \(a,\ b\)는 상수이다.)
...
$-1 \le x \le 4$에서 꼭짓점 $x=1$은 최솟값을 주고,
최댓값은 구간 끝점에서 나온다.
\[
f(-1)=1+2-2=1,\quad
f(4)=16-8-2=6
