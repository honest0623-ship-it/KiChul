...
LEGACY_ALIASES: Dict[Tuple[str, str, str], Tuple[str, str, str]] = {
    ...
    ("공통수학1(2022개정)", "2. 방정식과 부등식", "2-5. 여러 가지 방정식(교육과정 외)"): ("공통수학1(2022개정)", "2. 방정식과 부등식", "2-3. 여러 가지 방정식"),
    ...
    ("공통수학2(2022개정)", "3. 함수", "3-4. 여러 가지 함수의 그래프(교육과정 외)"): ("공통수학2(2022개정)", "3. 함수", "3-1. 함수"),
